...
import yaml
from models.modeling import BertForSeq2SeqDecoder
from tqdm import tqdm

from scripts.tokenization import BertTokenizer, WhitespaceTokenizer
...
def main():
    ...
    # Required parameters
    parser.add_argument("--bert_model", default=config["model"]["bert_model"], type=str, required=True,
                        help="Bert pre-trained model selected in the list: bert-base-uncased, "
                             "bert-large-uncased, bert-base-cased, bert-base-multilingual, bert-base-chinese.")
    parser.add_argument("--model_recover_path", default=config["model"]["model_recover_path"], type=str,
    ...
    parser.add_argument("--input_file", default=config["data"]["input_file"], type=str, help="Input file")
    parser.add_argument('--subset', type=int, default=config.get("decode", {}).get("subset", 0),
                        help="Decode a subset of the input dataset.")
    parser.add_argument("--output_file", default=config["data"]["output_file"], type=str, help="output file")
    parser.add_argument("--split", type=str, default="",
                        help="Data split (train/val/test).")
    parser.add_argument('--tokenized_input', action='store_true',
                        help="Whether the input is tokenized.")
    parser.add_argument('--seed', type=int, default=config["logging"]["seed"], ###default was 123
    ...
    parser.add_argument('--batch_size', type=int, default=config["decode"]["batch_size"],
                        help="Batch size for decoding.")
    parser.add_argument('--beam_size', type=int, default=1,
                        help="Beam size for searching")
    parser.add_argument('--length_penalty', type=float, default=config["decode"]["length_penalty"],
    ...
    parser.add_argument('--max_tgt_length', type=int, default=config["decode"]["max_tgt_length"],
